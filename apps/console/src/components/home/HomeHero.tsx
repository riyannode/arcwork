...
export default function HomeHero() {
  return (
    <div className="relative flex max-w-[530px] flex-col justify-center">
      {/* Kicker */}
      ...
      <h1
        ...
        style={{
          fontSize: 'clamp(32px, 3.3vw, 56px)',
          lineHeight: 0.9,
        }}
      >
      ...
      {/* Divider */}
      <div className="my-3 flex max-w-[440px] items-center gap-3">
      ...
      {/* Body */}
      <p className="aureo-body max-w-[500px] text-[14px] text-[#9a9a9a] md:text-[14px]">
        ArcLayer is a{' '}
      ...
      <div className="mt-2 max-w-[490px]">
        <div className="aureo-mono-label mb-1.5">QUICKSTART</div>
        <pre className="code-block py-2">
