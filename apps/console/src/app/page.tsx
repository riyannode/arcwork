  ...
  return (
    ...
    >
      ...
      <main className="relative z-20 min-h-screen md:pl-[48px]">
        <div className="relative mx-auto grid max-w-[1320px] grid-cols-1 gap-6 px-3 py-10 md:ml-0 md:mr-auto md:grid-cols-[1fr_0.85fr] md:gap-7 md:px-4 md:py-12 lg:px-5">
          <HomeHero />
