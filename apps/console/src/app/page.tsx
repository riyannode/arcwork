...
export default function Home() {
  return (
    ...
    >
      ...
      */}
      <main className="relative z-20 min-h-[calc(100svh-80px)] overflow-x-clip px-4 pt-7 pb-8 md:px-8 md:pt-8 md:pb-9 lg:px-10 xl:px-12">
        <div className="relative grid min-h-[calc(100svh-80px)] grid-cols-1 gap-y-5 md:grid-cols-12 md:items-center md:gap-x-12 xl:gap-x-14 2xl:gap-x-16">
          <div className="md:col-span-5 md:max-w-[540px] md:justify-self-start md:pl-4 lg:pl-6">
            <HomeHero />
          </div>

          <div className="relative flex flex-col gap-3.5 md:col-span-7 md:min-h-[470px] md:justify-self-end md:w-full md:max-w-[820px]">
