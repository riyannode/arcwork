          ...
          <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-7 text-[#9C9080]">
                ArcLayer manifests now expose parent runtime metadata plus child roles. Apolo can deterministically rank agents by role, category, capabilities, and x402 readiness before sending paid work.
              </p>
            </div>
